                    ...
                    public void run() {
                        try {
                            ...
                            activity.runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(context, "Співробітника видалено", Toast.LENGTH_SHORT).show();
                                    activity.startActivity(intent);
                                    activity.finish();
                                }
                            }); return;
                            ...
                            activity.runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(context, "Помилка видалення співробітника", Toast.LENGTH_SHORT).show();
                                }
                            }); return;
                        }
                    }
                ...
                new Thread(new Runnable() {
                    public void run() {
                        try {
                            ...
                            activity.runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(context, "Помилка видалення компанії", Toast.LENGTH_SHORT).show();
                                }
                            }); return;
                        }
                    }
                ...
                new Thread(new Runnable() {
                    public void run() {
                        try {
                            ...
                            Toast.makeText(context, "Помилка взаємодії з базою даних", Toast.LENGTH_SHORT).show();
                        }
                    }
                }).start();
            }
                ...
                new Thread(new Runnable() {
                    public void run() {
                        try {
                            ...
                            activity.runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(context, "Помилка видалення товарної позиції", Toast.LENGTH_SHORT).show();
                                }
                            }); return;
                        }
                    }
