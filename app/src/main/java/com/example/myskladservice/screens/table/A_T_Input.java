...
public class A_T_Input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.d4_input_table);
        Vibrator vibrator = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    DialogsViewer.twoButtonDialog(
                            context, new Intent(A_T_Input.this, A_T_Input.class),
        ...
        class CheckingPrint extends AsyncTask<Void, Void, Void> {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    resultSet.next(); int company = resultSet.getInt("id");
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        resultSet = MS_SQLSelect.ReadInput(mssqlConnection, company, newDate.get());
                    }

                    int iter = 0;
                    while (resultSet.next()) {
                        View temp = getLayoutInflater().inflate(R.layout.template_view_input, TableView, false);
                        ...
                        switch (resultSet.getInt("state")){
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                state.setText("Надходження опрацьовано");
                                temp.setAlpha(0.4f);
                                break;
                        }
        ...
        CheckingPrint checkingPrint = new CheckingPrint(new TaskInterface() {
            ...
            public void onTaskComplete() {
                ...
                if (View_s.isEmpty()) {
                    infostate.setText("Дані про надходження відсутні");
                } else{
