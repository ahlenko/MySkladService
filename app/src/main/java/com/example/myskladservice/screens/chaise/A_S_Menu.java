...
public class A_S_Menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c1_main_menu);
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    DialogsViewer.twoButtonDialog(
                            context, new Intent(A_S_Menu.this, A_S_Menu.class),
        ...
        taskmanager_btn.setOnClickListener (enter -> {
            vibrator.vibrate(50);
        ...
        analitics_btn.setOnClickListener (enter -> {
            vibrator.vibrate(50);
