...
public class A_R_User extends AppCompatActivity {
    ...
    public void onBackPressed() {
        DialogsViewer.twoButtonDialog(
                this,  new Intent(A_R_User.this, AM_Login.class), this, "Відміна",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b2_reg_main_user);
        ...
        continue_reg_btn.setOnClickListener(enter -> {
                            ...
                            if (enter_err == 0) {
                                ...
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        vibrator.vibrate(50);
                                        Intent intent;
                                        intent = new Intent(A_R_User.this, A_S_Menu.class);
